	...
	return (
		<div>
			<DropdownMenu.Root >
				...
				<DropdownMenu.Content sideOffset={8} align="end" className="z-100  md:backdrop-blur-sm md:bg-gradient-to-br from-white/30 via-white/20 to-white/10  md:w-60 w-40   md:pt-2 pt-1 pb-1 md:pb-2 border-2 flex flex-col  rounded-lg  ">
